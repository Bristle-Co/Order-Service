...
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('3a3b3d7e-4297-485a-a012-f4d8c4bd5bdc','model 3',2000,3,2,2);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('3e8e1456-1666-4f9e-8f55-8766f2212359','model 4',2000,4,2,2);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('4cfa15c9-f066-400d-92ea-7eff69825d67','model 5',3000,5,3,3);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('4f950d54-591d-49be-bb7a-a48950cbfa77','model 6',3000,6,3,3);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('5475c400-3740-4936-8bb1-dcc6ba3ae33e','model 7',4000,7,4,4);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('5b0b8ed9-5765-4f91-a420-32d6cb2bb906','model 8',4000,8,4,4);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('6e865335-f864-4261-ae6d-0ed186e4714c','model 9',5000,9,5,5);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('b2e50e28-2b6a-4ba9-8377-5cefce40395c','model 10',5000,10,5,5);
INSERT INTO `product_entries` (`product_entry_id`,`model`,`price`,`product_ticket_id`,`quantity`,`order_id_fk`) VALUES ('bef7fbb4-4962-4732-98ef-1f723074bba5','model 11',6000,1,6,6);
